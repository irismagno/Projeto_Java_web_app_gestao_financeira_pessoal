			...
			<div class="card estilo-card cor-flutuante text-center">
				...
				<div class="card-body centralizaB">
					...
					<form action="fintech" method="post">
						<input type="hidden" value="cadastrarGasto" name="acao">
						...
						<div class="form-group mt-1 fw-bold secundarias-card">
							...
							<select name="conta" id="id-conta" class="form-control">
								...
								<c:forEach items="${contas}" var="c">
									<option value="${c.numeroConta}" >${c.descricao}</option>
								</c:forEach>							
							</select>
						</div>
						<div class="form-group mt-1 fw-bold secundarias-card">
						...
						<a href="fintech?acao=abrir-index" class="btn btn-danger mt-2">Voltar</a>
					</form>				
			  </div>
		 </div>
	</main>

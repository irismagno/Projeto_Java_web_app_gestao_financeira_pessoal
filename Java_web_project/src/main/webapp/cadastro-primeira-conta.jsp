...
<body class="cor-fundo-corpo">
	...
	<div class="row cor-fundo-cabecalho">
		<div class="col">
			...
			<h1 class="nome-rv">
				<i class="fa fa-user nome-usuario">Olá ${nomeUsuario}!</i>
			</h1>
		</div>
	</div>
	</header>
	...
	<div class="row">
		<div class="col">
			<div class="card estilo-card cor-flutuante text-center">
				<h2 class="float-start titulo-card mt-2 fw-bold">Agora cadastre uma conta corrente:</h2>
				<div class="card-body centralizaB">
					...
					<form action="fintech" method="post">
						<input type="hidden" value="cadastrarPrimeiraConta" name="acao">
						...
						<input type="submit" value="Concluir" class="btn btn-primary mt-4">						
					</form>				
			  </div>
		 </div>
	</main>

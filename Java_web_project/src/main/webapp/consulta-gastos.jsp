	  ...
	  <div class="row">
		<div class="col">
			<div class="card estilo-card cor-flutuante text-center">
				...
				<h4 class="mt-2">Histórico de gastos:</h4>
				...
				<table class="table table-striped secundarias-card">
					  ...
					  <tr>
						<td class="fw-bold">R$ ${g.valor}</td>
						<td class="fw-bold">${g.descricao}</td>
						<td class="fw-bold">
							<fmt:formatDate value="${g.data.time}" pattern="dd/MM/yyyy"/>
						</td>
					  <td>
						<div class="btn-group dropstart">
						  ...
						  <ul class="dropdown-menu cor-offcanvas ps-2 pe-2">
						   <c:url value="fintech" var="link">
							<c:param name="acao" value="abrir-form-edicao-gastos"/>
					        ...
					        <form action="fintech" method="post">
				      		...
				      		<input type="hidden" name="codigoExcluir" value="${g.codigoGasto}">
	...
	<footer class="container-fluid rodape d-flex justify-content-center">
		  <div class="row">
		   	<div class="col text-center" >
		   		<a href="fintech?acao=abrir-form-cadastro-gasto" class="btn btn-primary botoesrodape mt-3"><i class="bi bi-dash-square"></i>Incluir</a>
